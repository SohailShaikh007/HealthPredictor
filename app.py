...
def getDiseaseInfo(keywords):
    '''results = duckduckgo_search.search(keywords, region='wt-wt', safesearch='Off', time='y')
    return results[0]['body']'''
    search_results = search(keywords, num=1, stop=1)
    ...
    if request.args["message"]=="undefined":
        ...
        if currentState==4:
            ...
            if '1' in user_message or 'disease' in user_message:
                ...
                response.append("<b>The following disease may be causing your discomfort is:</b>")
